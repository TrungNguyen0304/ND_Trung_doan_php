...
<body>
	...
	<!-- SIDEBAR -->
	<section id="sidebar">
		<a href="#" class="brand"><img src="../public/image/logo.png" width="30px" height="30px" alt=""></i> AdminBurger</a>
		<ul class="side-menu">
			...
			<li><a href="./categories/index.php"><i class='bx bxs-widget icon'></i> Categories</a></li>
			...
			<div class="top-navbar">
				<div class="icons">
					...
					if (isset($_SESSION['name'])) {
						echo '' . $_SESSION['name']  . '<a href="logout.php"  class="btn btn-primary ms-3 ">Đăng Xuất</a>';
					} else {
